...
insert into provinces (province_id,contact_details,branch,email_address,postal_code,business_tell,cell,status)values ('Whynburg','Yaasier Haroun','64 Main Road, 2nd Floor, Old Absa Building64 Main Road, 2nd Floor, Old Absa Building','wynbergbranch@credit-rescue.co.za','7800','217620039','N/A','Active');
